...
async function main() {
  ...
  await db.kycSubmission.create({
    data: {
      ...
      city: 'Karachi',
      documentImage: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==',
      status: 'PENDING',
    },
  })
  ...
  await db.topUpRequest.create({
    data: {
      ...
      reference: 'JC-881234',
      screenshot: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==',
      coinsGranted: 100,
      status: 'APPROVED',

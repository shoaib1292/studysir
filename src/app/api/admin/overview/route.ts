...
export async function GET() {
  try {
    ...
    const [
      ...
      coinSum, moneySum, commissionAgg, paidTxRows, milestonePaidSetting,
      ...
      db.coinTransaction.groupBy({ by: ['userId'], where: { type: 'PURCHASE', amount: { gt: 0 } } }),
    ...
    const overview: AdminOverview = {
      ...
      money: {
        ...
        paidTeachers: paidTxRows.length,
        milestoneTarget,
        milestonePaid,
      },
      signups,
